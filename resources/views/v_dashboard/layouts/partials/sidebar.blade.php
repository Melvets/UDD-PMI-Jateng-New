...
<li class="side-link_ nav-item">
    <a class="nav-link {{ Request::is('dashboard/pendonor*') ? 'active-side' : '' }}" href="{{ route('pendonor.index') }}">
...
<li class="side-link_ nav-item">
    <a class="nav-link {{ Request::is('dashboard/users*') ? 'active-side' : '' }}" href="/dashboard/users">
      <span class="nav-link-icon d-md-none d-lg-inline-block">
        <span class="nav-link-icon d-md-none d-lg-inline-block">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-users" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /><path d="M21 21v-2a4 4 0 0 0 -3 -3.85" /></svg>
          </span>
...
<li class="side-link_ nav-item">
    <a class="nav-link {{ Request::is('dashboard/catatan*') ? 'active-side' : '' }}" href="/dashboard/catatan">
      <span class="nav-link-icon d-md-none d-lg-inline-block">
        <span class="nav-link-icon d-md-none d-lg-inline-block">
...
{{-- <li class="side-link_ nav-item">
    <a class="nav-link {{ Request::is('dashboard/users*') ? 'active-side' : '' }}" href="/logout" style="color: #e60000; font-weight: bold">
        <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
