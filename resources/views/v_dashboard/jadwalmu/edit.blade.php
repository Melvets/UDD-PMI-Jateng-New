            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col">
                    ...
                    <div class="page-pretitle">
                        <a href="/dashboard" class="text-secondary">/dashboard</a><a href="/dashboard/jadwalmu"
                            class="text-secondary">/jadwalmu</a>/edit
                    </div>
                    <h2 class="page-title">
                        Edit Jadwal
                    </h2>
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" name="tempat" id="tempat"
                                                    ...
                                                    value="{{ old('tempat', $dataJadwalMU->tempat) }}">
                                                @error('tempat')
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" name="alamat" id="alamat"
                                                    ...
                                                    placeholder="Wajib diisi ..." required
                                                    value="{{ old('alamat', $dataJadwalMU->alamat) }}">
                                                @error('alamat')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-1">
                                                ...
                                                <select class="form-select" id="kabkot" name="kabkot">
                                                    <option value="{{ $dataJadwalMU->kabkot }}" selected>
                                                        {{ $dataJadwalMU->kabkot }}</option>
                                        ...
                                        <div class="col-md-2">
                                            <div class="mb-1">
                                                ...
                                                <input type="time" name="jam_mulai" id="jam_mulai"
                                                    ...
                                                    placeholder="Wajib diisi ..." required
                                                    value="{{ old('jam_mulai', $dataJadwalMU->jam_mulai) }}">
                                                @error('jam_mulai')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="mb-1">
                                                ...
                                                <input type="time" name="jam_selesai" id="jam_selesai"
                                                    ...
                                                    placeholder="Wajib diisi ..." required
                                                    value="{{ old('jam_selesai', $dataJadwalMU->jam_selesai) }}">
                                                @error('jam_selesai')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-md-5">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="tanggal" id="tanggal"
                                                    ...
                                                    value="{{ old('tanggal', $dataJadwalMU->tanggal) }}">
                                                @error('tanggal')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <div>
                                                    <label class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="peruntukan"
                                                            value="Umum"
                                                            @if ($dataJadwalMU->peruntukan == 'Umum') @checked(true) @endif>
                                                    ...
                                                    <label class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="peruntukan"
                                                            value="Internal"
                                                            @if ($dataJadwalMU->peruntukan == 'Internal') @checked(true) @endif>
