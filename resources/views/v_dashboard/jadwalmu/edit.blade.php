...
@section('container')
    ...
    <div class="page-pretitle">
        <a href="/dashboard" class="text-secondary">/dashboard</a><a href="/dashboard/jadwalmu" class="text-secondary">/jadwalmu</a>/edit
        </div>
        <h2 class="page-title">
            Edit Jadwal
        </h2>
    ...
    <div class="col-lg-12">
        <div class="row row-cards">
            <div class="col-12">
                ...
                <form action="/dashboard/jadwalmu/{{ $dataJadwalMU->id }}" method="POST" class="card">
                        ...
                        <div class="row row-cards">
                            ...
                            <div class="col-md-3">
                                <div class="mb-1">
                                    ...
                                    <input type="text" name="tempat" id="tempat" class="form-control @error('tempat') is-invalid @enderror" placeholder="Wajib diisi ..." required value="{{ old('tempat', $dataJadwalMU->tempat) }}">
                                    @error('tempat')
                            ...
                            <div class="col-md-6">
                                <div class="mb-1">
                                    ...
                                    <input type="text" name="alamat" id="alamat" class="form-control @error('alamat') is-invalid @enderror" placeholder="Wajib diisi ..." required value="{{ old('alamat', $dataJadwalMU->alamat) }}">
                                    @error('alamat')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-1">
                                    ...
                                    <select class="form-select" id="kabkot" name="kabkot">
                                        <option value="{{ $dataJadwalMU->kabkot }}" selected>{{ $dataJadwalMU->kabkot }}</option>
                                ...
                                <div class="mb-1">
                                    ...
                                    <div>
                                        <label class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="peruntukan" value="Umum" @if ($dataJadwalMU->peruntukan == 'Umum') @checked(true) @endif>
                                            <span class="form-check-label">Umum</span>
                                        </label>

                                        <label class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="peruntukan" value="Internal" @if ($dataJadwalMU->peruntukan == 'Internal') @checked(true) @endif>
