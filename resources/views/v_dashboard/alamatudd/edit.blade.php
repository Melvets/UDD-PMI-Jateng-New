            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col">
                    ...
                    <div class="page-pretitle">
                        <a href="/dashboard" class="text-secondary">/dashboard</a><a href="/dashboard/alamatudd"
                            class="text-secondary">/alamatUDD</a>/edit
                    </div>
                    <h2 class="page-title">
                                    ...
                                    <div class="row row-cards">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" name="udd_kabkot"
                                                    class="form-control @error('udd_kabkot') is-invalid @enderror"
