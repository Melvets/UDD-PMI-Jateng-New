                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-1">
                                                ...
                                                <input type="number" name="golda_a" id="golda_a"
                                                    ...
                                                    placeholder="Wajib diisi ..." required value="{{ old('golda_a') }}">
                                                @error('golda_a')
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-1">
                                                ...
                                                <input type="number" name="golda_b" id="golda_b"
                                                    ...
                                                    placeholder="Wajib diisi ..." required value="{{ old('golda_b') }}">
                                                @error('golda_b')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-1">
                                                ...
                                                <input type="number" name="golda_ab" id="golda_ab"
                                                    ...
                                                    placeholder="Wajib diisi ..." required value="{{ old('golda_ab') }}">
                                                @error('golda_ab')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-1">
                                                ...
                                                <input type="number" name="golda_o" id="golda_o"
                                                    ...
                                                    placeholder="Wajib diisi ..." required value="{{ old('golda_o') }}">
                                                @error('golda_o')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
