                        ...
                        <div class="row row-cards">
                            ...
                            <div class="col-md-3">
                                <div class="mb-1">
                                    ...
                                    <input type="number" name="golda_a" id="golda_a" class="form-control @error('golda_a') is-invalid @enderror" placeholder="Wajib diisi ..." required value="{{ $dataStokDarah->golda_a }}">
                                    @error('golda_a')
                            ...
                            <div class="col-md-3">
                                <div class="mb-1">
                                    ...
                                    <input type="number" name="golda_b" id="golda_b" class="form-control @error('golda_b') is-invalid @enderror" placeholder="Wajib diisi ..." required value="{{ old('golda_b', $dataStokDarah->golda_b) }}">
                                    @error('golda_b')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-1">
                                    ...
                                    <input type="number" name="golda_ab" id="golda_ab" class="form-control @error('golda_ab') is-invalid @enderror" placeholder="Wajib diisi ..." required value="{{ old('golda_ab', $dataStokDarah->golda_ab) }}">
                                    @error('golda_ab')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-1">
                                    ...
                                    <input type="number" name="golda_o" id="golda_o" class="form-control @error('golda_o') is-invalid @enderror" placeholder="Wajib diisi ..." required value="{{ old('golda_o', $dataStokDarah->golda_o) }}">
                                    @error('golda_o')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
