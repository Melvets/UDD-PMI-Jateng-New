            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col">
                    ...
                    <div class="page-pretitle">
                        <a href="/dashboard" class="text-secondary">/dashboard</a><a href="/dashboard/stokdarah"
                            class="text-secondary">/stokdarah</a>
                    </div>
                    <h2 class="page-title">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="/dashboard/stokdarah/create" class="btn d-none d-sm-inline-block text-white"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-inline-flex">
                                                    <a href="/dashboard/stokdarah/{{ $data->id }}/edit"
